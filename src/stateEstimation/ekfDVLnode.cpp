...
#include "bluerov2commonmsgs/srv/reset_ekf.hpp"
#include "bluerov2commonmsgs/msg/height_stamped.hpp"
//#include <chrono>
#include <thread>
//#include "bluerov2common/ekfParameterConfig.h"
//#include <dynamic_reconfigure/server.h>
#include <bluerov2commonmsgs/msg/state_of_blue_rov.hpp>
...
//        this->serviceResetEkf = this->create_service<bluerov2commonmsgs::srv::ResetEkf>("resetCurrentEKF",
...
//    std::deque<geometry_msgs::TwistStamped::ConstPtr> dvlDeque;
    ...
    //subscriber
    rclcpp::Subscription<bluerov2commonmsgs::msg::HeightStamped>::SharedPtr subscriberDepthOwnTopic;
...
//        std::cout << "getting DVL message" << std::endl;
    ...
    void depthSensorBaroPX4(const px4_msgs::msg::SensorBaro::SharedPtr msg) {
        ...
        bluerov2commonmsgs::msg::HeightStamped newMsg{};
...
//        std::cout <<  newMsg.height << std::endl;
    ...
    void depthSensorVehicleAir(const px4_msgs::msg::VehicleAirData::SharedPtr msg) {
        ...
        bluerov2commonmsgs::msg::HeightStamped::SharedPtr newMsg;
...
//    rclcpp::Publisher publisherEasyReadEkf = (*n_).advertise<bluerov2commonmsgs::stateOfBlueRov>("ekfStateRPY", 10);
...
//        bluerov2commonmsgs::stateOfBlueRov msgForRPYState;
