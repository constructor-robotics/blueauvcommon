...
#include <chrono>
#include "bluerov2commonmsgs/msg/desired_state_for_robot.hpp"
...
public:
    controllerOfBluerov2() : Node("controllerBlueROV") {
        ...
        this->subscriberDesiredState = this->create_subscription<bluerov2commonmsgs::msg::DesiredStateForRobot>(
    ...
    void controllLogic(Eigen::Vector3d &des_thrust, Eigen::Vector3d &des_rpy);
...
//    void callbackReconfiguration(bluerov2common::controllerConfig &config, uint32_t level);
    ...
    void getRollPitchYawThrustControllLogic(Eigen::Vector3d &des_thrust, Eigen::Vector3d &des_rpy);

private:
    rclcpp::Subscription<bluerov2commonmsgs::msg::DesiredStateForRobot>::SharedPtr subscriberDesiredState;
    ...
    //functions
    void desiredStateCallback(const bluerov2commonmsgs::msg::DesiredStateForRobot::SharedPtr msg);
